...
#Inst Vars
INSTVARS<-c("CCSTATUS","INSTDESCR03","INSTDESCR08","INSTOPN10","INSTOPN11", "DEPT","DEPTDISC", "INSTTYPE","MAJORA","DEPTA","INSTCONT","SELECTIVITY","CARNEGIE")   
...
#Other Vars
OTHERVARS<-c("CCRANK","ADMCHAIR","ADMDEAN","ADMPRES","ADMVP","ADMPROVOST","ADMOTHER","ADMNA","CRSTYPE01","CRSENROLL01","GENACT03","GENACT04", "PASTACT01","PASTACT02","PASTACT03","PASTACT04", "RESTYPE", "STATE","OBEREG")
