...
#Work Vars
WORKVARS<-c("PRINACT","ACADRANK","TENURE", "COURSENUM","HPW01","HPW02","HPW03","HPW04","HPW05","HPW06","HPW07","HPW08","HPW09","HPW10","HPW11","HPW12","HPW13","GENACT01","APPTYR")
# FULLSTAT and TENUREYR REMOVED from WORKVARS

#Salary Vars
SALARYVARS<-c("SALARY","SALARYBASE","SALARY12", "SALARYSOURCE01","SALARYSOURCE02","SALARYSOURCE03","SALARYSOURCE04")

#Inst Vars
INSTVARS<-c("INSTDESCR03","INSTDESCR08","INSTOPN10","INSTOPN11", "INSTTYPE","MAJORA","DEPTA","INSTCONT","SELECTIVITY","CARNEGIE")   
# removed "DEPT","DEPTDISC" but still have DEPTA to capture this
...
#Other Vars
OTHERVARS<-c("ADMCHAIR","ADMDEAN","ADMPRES","ADMVP","ADMPROVOST","ADMOTHER","ADMNA","CRSTYPE01","CRSENROLL01","GENACT03","GENACT04", "PASTACT01","PASTACT02","PASTACT03","PASTACT04", "STATE","OBEREG")
# RESTYPE removed
...
# Full-time Vars (Pertain only to FT faculty)
FTVARS<-c("SALARY")
# removed SALARY12

# Part-time Vars (Pertain only to PT faculty)
PTVARS<-c("PTCHOICE","PTWORKFT","PTCAREER","PTREASON01","PTREASON02","PTREASON03","PTREASON04","PTREASON05","PTREASON06","PTREASON07","PTRESOURCES01","PTRESOURCES02","PTRESOURCES03","PTRESOURCES04","PTRESOURCES05","PTOPN01","PTOPN02","PTOPN03","PTOPN04","PTOPN05","PTOPN06","PTOPN07","PTOPN08","PTOPN09","PTOPN10","PTTEACH","PTSALARY","PTPAY")   
# PTSEEK, CCSTATUS, CCRANK removed
# My vars
